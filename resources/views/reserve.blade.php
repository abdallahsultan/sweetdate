...
<div class="row vertical-align">
                 ...
                 <div class="col-sm-6">
                     ...
                     <a href="{{url('reserve/indoor')}}" title=""><img src="{{asset('website/img/indoor.jpg')}}"style="height:351px"  class="img-responsive img-thumbnail"></a>
                 </div>
                 <div class="col-sm-6">
                     ...
                     <a href="{{url('reserve/outdoor')}}" title=""><img src="{{asset('website/img/outdoor.jpg')}}" style="height:351px"  class="img-responsive img-thumbnail"></a>
                 </div>
