...
<div class="row">
    <form method="POST" action="{{ route('saveopenion') }}">
        ...
        <div class="col-md-5 col-md-offset-1">
            ...
            <input type="text" placeholder="@lang('site.name')" class="form-control"  name="name" required>
        </div>
        <div class="col-md-5">
            <label> @lang('site.phone') </label>
            <input type="number" placeholder="@lang('site.phone')" class="form-control"  name="phone" required>
        </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <textarea class="form-control" placeholder="@lang('site.openion')" name="message" rows="6"></textarea>
                        </div>
